...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for task in tasks:
            ...
            noise_words = ['samsung', 'google', 'pixel', 'nokia', 'motorola', 'case', 'box', 'parts', 'broken', 'cracked', 'damaged', 'locked']
    ...
    def send_alert_email(self, items_list, task,recipient_email):
        ...
        try:
            send_mail(
                ...
                ['zzj20050510@hotmail.com'], # 填入你的 个人 邮箱
                fail_silently=False,
            )
            print(f"📢 成功发送邮件至个人邮箱！")
        except Exception as e:
