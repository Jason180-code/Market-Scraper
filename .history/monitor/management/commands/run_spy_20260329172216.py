...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for task in tasks:
            ...
            noise_words = ['case', 'cover', 'glass', 'screen protector', 'tempered', 
    'film', 'lens', 'dummy', 'box only', 'parts', 'damaged',
    'broken', 'icloud locked', 'repair', 'adapter', 'cable', 
    'shell', 'skin', 'sticker', 'privacy', 'bundle', 'charger']
