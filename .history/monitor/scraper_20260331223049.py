...
def scrape_ebay(keywords, max_price, min_price=100):
    ...
    try:
        ...
        BLACK_LIST = [
            ...
            "parts", "box only", "broken", "faulty", "crack", "damaged", "repair",
        ...
        for el in li_elements:
            ...
            title_lower = title.lower()
                ...
                core_keyword_clean = keywords.replace(" ", "").lower()[:8] # 拿到 "iphone17"
                # 在判断时：
                if core_keyword_clean not in title_lower.replace(" ", ""):
                    continue
